...
export default function TransformPage() {
  ...
  const { data: isActive } = useReadContract({
    address: process.env.NEXT_PUBLIC_NEW_CONTRACT_ADDRESS,
    abi: [{
      name: "isTransformationPeriodActive",
      type: "function",
      stateMutability: "view",
      inputs: [],
      outputs: [{ name: "", type: "bool" }],
    }],
    functionName: "isTransformationPeriodActive",
    args: [],
  });
  ...
  const handleConvert = async () => {
    ...
    // Check if transformation period is active
      ...
      await writeContractAsync({
        ...
        args: [selectedNfts.map((nft) => BigInt(nft.id))],
      });
